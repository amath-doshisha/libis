...
void multi_mldivide(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
  ...
  if(_M(x)==1 && _N(x)==1 && _L(x)==1){
    ...
    if(_T(x)=='r' && _T(y)=='r'){ z=multi_allocate('r',_N(x),_N(y),1); rsolve(_M(y),_N(y),_R(y),_LD1(y),_R(x),_LD1(x),&info); rmat_copy(_M(y),_N(y),_R(z),_LD1(z),_R(y),_LD1(y)); }
    else if(_T(x)=='r' && _T(y)=='c'){ v=multi_allocate('c',_N(x),_M(x),1); cmat_copy_rmat(_M(x),_N(x),_C(v),_LD1(v),_R(x),_LD1(x)); z=multi_allocate('c',_N(x),_N(y),1); csolve(_M(y),_N(y),_C(y),_LD1(y),_C(x),_LD1(x),&info); cmat_copy(_M(y),_N(y),_C(z),_LD1(z),_C(y),_LD1(y)); }
    else if(_T(x)=='c' && _T(y)=='r'){ u=multi_allocate('c',_N(y),_M(y),1); cmat_copy_rmat(_M(y),_N(y),_C(u),_LD1(u),_R(y),_LD1(y)); z=multi_allocate('c',_N(x),1,1); csolve(_M(y),_N(y),_C(y),_LD1(y),_C(x),_LD1(x),&info); cmat_copy(_M(y),_N(y),_C(z),_LD1(z),_C(y),_LD1(y)); }
    else if(_T(x)=='c' && _T(y)=='c'){ z=multi_allocate('r',_N(x),1,1); csolve(_M(y),_N(y),_C(y),_LD1(y),_C(x),_LD1(x),&info); cmat_copy(_M(y),_N(y),_C(z),_LD1(z),_C(y),_LD1(y)); }
    else{ MATLAB_ERROR("multi_mldivide: Unkown type"); }
    if(info!=0){ MATLAB_ERROR("multi_mldivide: csolve error."); }
  }else{

...
/**
 @brief rmulti型の3次元配列の列方向の最大値 B=rmat3_minm(A).
*/
int rmat3_minm(int m, int n, int l, rmulti **B, int LDB1, int LDB2, rmulti **A, int LDA1, int LDA2)
{
  int i,j,k,e=0;
  for(k=0; k<l; k++){
    for(j=0; j<n; j++){
...
/**
 @brief rmulti型の3次元配列の行方向の最大値 B=rmat3_minn(A).
*/
int rmat3_minn(int m, int n, int l, rmulti **B, int LDB1, int LDB2, rmulti **A, int LDA1, int LDA2)
{
  int j,k,e=0;
  for(k=0; k<l; k++){
...
/**
 @brief rmulti型の3次元配列のL方向の最大値 B=rmat3_minl(A).
*/
int rmat3_minl(int m, int n, int l, rmulti **B, int LDB1, int LDB2, rmulti **A, int LDA1, int LDA2)
{
  int k,e=0;
...
/**
 @brief cmulti型の3次元配列の列方向の最大値 B=cmat3_minm(A).
*/
int cmat3_minm(int m, int n, int l, cmulti **B, int LDB1, int LDB2, cmulti **A, int LDA1, int LDA2)
{
...
/**
 @brief cmulti型の3次元配列の行方向の最大値 B=cmat3_minn(A).
*/
int cmat3_minn(int m, int n, int l, cmulti **B, int LDB1, int LDB2, cmulti **A, int LDA1, int LDA2)
{
...
/**
 @brief cmulti型の3次元配列のL方向の最大値 B=cmat3_minl(A).
*/
int cmat3_minl(int m, int n, int l, cmulti **B, int LDB1, int LDB2, cmulti **A, int LDA1, int LDA2)
{
  int k,e=0,buf,prec;
  prec=cmat3_get_prec_max(m,n,l,A,LDA1,LDA2);
  rmulti* angle1=rallocate_prec(prec);
...
void multi_min(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
  ...
  int info=-1;
  if(nlhs>1){ mexErrMsgIdAndTxt("MATLAB:multi_mex:minlhs","Too many output arguments."); }
  ...
  if(_M(x)!=1){
    //press m
         if(_T(x)=='r'){ z=multi_allocate('r',1,_N(x),_L(x)); rmat3_minm(_M(x),_N(x),_L(x),_R(z),_LD1(z),_LD2(z),_R(x),_LD1(x),_LD2(x)); }
    else if(_T(x)=='c'){ z=multi_allocate('c',1,_N(x),_L(x)); cmat3_minm(_M(x),_N(x),_L(x),_C(z),_LD1(z),_LD2(z),_C(x),_LD1(x),_LD2(x)); }
  }else if(_N(x)!=1){
    //press n
         if(_T(x)=='r'){ z=multi_allocate('r',1,1,_L(x)); rmat3_minn(_M(x),_N(x),_L(x),_R(z),_LD1(z),_LD2(z),_R(x),_LD1(x),_LD2(x)); }
    else if(_T(x)=='c'){ z=multi_allocate('c',1,1,_L(x)); cmat3_minn(_M(x),_N(x),_L(x),_C(z),_LD1(z),_LD2(z),_C(x),_LD1(x),_LD2(x)); }
  }else if(_L(x)!=1){
    //press l
         if(_T(x)=='r'){ z=multi_allocate('r',1,1,1); rmat3_minl(_M(x),_N(x),_L(x),_R(z),_LD1(z),_LD2(z),_R(x),_LD1(x),_LD2(x)); }
    else if(_T(x)=='c'){ z=multi_allocate('c',1,1,1); cmat3_minl(_M(x),_N(x),_L(x),_C(z),_LD1(z),_LD2(z),_C(x),_LD1(x),_LD2(x)); }
    ...
    MATLAB_ERROR("multi_min: z=min(x): This function is not implemented");
  }

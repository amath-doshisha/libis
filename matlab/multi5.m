...
elseif nargout<=4
    [out1,out2,out3,out4]=multi_mex(cmd,get_default_prec(),double(get_default_round_mode()),double(get_auto_prec_mode()),varargin{1:end});
elseif nargout<=5
    [out1,out2,out3,out4,out5]=multi_mex(cmd,get_default_prec(),double(get_default_round_mode()),double(get_auto_prec_mode()),varargin{1:end});
else

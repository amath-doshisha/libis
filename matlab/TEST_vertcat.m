...
if isequal(double([C C C;C R C;C R C]),[AC AC AC;AC AR AC;AC AR AC])==false disp('false');end
...
if isequal(double([C;C;C;C;R;C;C;R]),[AC;AC;AC;AC;AR;AC;AC;AR])==false disp('false');end
if isequal(double([C C C;R R R;C C C]),[AC AC AC;AR AR AR;AC AC AC])==false disp('false');end

...
void cmat_clone(int m, int n, cmulti **B, int LDB, cmulti **A, int LDA)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      cclone_c(MAT(B,i,j,LDB),MAT(A,i,j,LDA));
    }
  }
}
...
void cmat_clone_t(int m, int n, cmulti **B, int LDB, cmulti **A, int LDA)
{
  ...
  for(i=0; i<m; i++){
    for(j=0; j<n; j++){
      cclone_c(MAT(B,j,i,LDB),MAT(A,i,j,LDA));
    }
  }
}
...
void cmat_load(int m, int n, cmulti **A, int LDA, char* fmt, ...)
{
  ...
  for(j=0;j<n;j++){
    for(i=0;i<m;i++){
      if(fgets(str,100000,fid)==NULL){ ERROR_AT; exit(0); }
      cset_s(MAT(A,i,j,LDA),str);
    }
  }
  // close
  fclose(fid);
...
void cmat_set_rand(int m, int n, cmulti **A, int LDA, double a, double b)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      ...
      cmul_cd(MAT(A,i,j,LDA),MAT(A,i,j,LDA),a);
      cadd_cd(MAT(A,i,j,LDA),MAT(A,i,j,LDA),b);
    }
  }
}
...
void cmat_copy(int m, int n, cmulti **B, int LDB, cmulti **A, int LDA)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      cset_c(MAT(B,i,j,LDB),MAT(A,i,j,LDA));
    }
  }
}
...
void cmat_copy_rmat(int m, int n, cmulti **B, int LDB, rmulti **A, int LDA)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      cset_r(MAT(B,i,j,LDB),MAT(A,i,j,LDA));
    }
  }
}
...
void cmat_copy_t(int m, int n, cmulti **B, int LDB, cmulti **A, int LDA)
{
  ...
  for(i=0; i<m; i++){
    for(j=0; j<n; j++){
      cset_c(MAT(B,j,i,LDB),MAT(A,i,j,LDA));
    }
  }
}
...
void cmat_copy_rmat_t(int m, int n, cmulti **B, int LDB, rmulti **A, int LDA)
{
  ...
  for(i=0; i<m; i++){
    for(j=0; j<n; j++){
      cset_r(MAT(B,j,i,LDB),MAT(A,i,j,LDA));
    }
  }
}
...
void cmat_copy_ct(int m, int n, cmulti **B, int LDB, cmulti **A, int LDA)
{
  ...
  for(i=0; i<m; i++){
    for(j=0; j<n; j++){
      cconj_c(MAT(B,j,i,LDB),MAT(A,i,j,LDA));
    }
  }
}
...
void cmat_copy_index(int m, int n, cmulti **B, int LDB, cmulti **A, int LDA, int *I, int *J)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      if(I!=NULL && J!=NULL){ cset_c(MAT(B,i,j,LDB),MAT(A,I[i],J[j],LDA)); }
    }
  }
}
...
void cmat_index_copy(int m, int n, cmulti **B, int LDB, cmulti **A, int LDA, int *I, int *J)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      if(I!=NULL && J!=NULL){ cset_c(MAT(B,I[i],J[j],LDB),MAT(A,i,j,LDA)); }
    }
  }
}
...
void cmat_index_copy_rmat(int m, int n, cmulti **B, int LDB, rmulti **A, int LDA, int *I, int *J)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      if(I!=NULL && J!=NULL){ cset_r(MAT(B,I[i],J[j],LDB),MAT(A,i,j,LDA)); }
    }
  }
}
...
void cmat_real(int m, int n, rmulti **B, int LDB, cmulti **A, int LDA)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      rset_r(MAT(B,i,j,LDB),C_R(MAT(A,i,j,LDA)));
    }
  }
}
...
void cmat_real_clone(int m, int n, rmulti **B, int LDB, cmulti **A, int LDA)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      rclone_r(MAT(B,i,j,LDB),C_R(MAT(A,i,j,LDA)));
    }
  }
}
...
void cmat_imag(int m, int n, rmulti **B, int LDB, cmulti **A, int LDA)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      rset_r(MAT(B,i,j,LDB),C_I(MAT(A,i,j,LDA)));
    }
  }
}
...
void cmat_imag_clone(int m, int n, rmulti **B, int LDB, cmulti **A, int LDA)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      rclone_r(MAT(B,i,j,LDB),C_I(MAT(A,i,j,LDA)));
    }
  }
}
...
void cmat_conj(int m, int n, cmulti **B, int LDB, cmulti **A, int LDA)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      cconj_c(MAT(B,i,j,LDB),MAT(A,i,j,LDA));
    }
  }
}
...
void cmat_neg(int m, int n, cmulti **B, int LDB, cmulti **A, int LDA)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      cneg_c(MAT(B,i,j,LDB),MAT(A,i,j,LDA));
    }
  }
}
...
void cmat_abs2(int m, int n, rmulti **B, int LDB, cmulti **A, int LDA)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      rabs2_c(MAT(B,i,j,LDB),MAT(A,i,j,LDA));
    }
  }
}
...
void cmat_add(int m, int n, cmulti **C, int LDC, cmulti **A, int LDA, cmulti **B, int LDB)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      cadd_cc(MAT(C,i,j,LDC),MAT(A,i,j,LDA),MAT(B,i,j,LDB));
    }
  }
}
...
void cmat_add_rmat(int m, int n, cmulti **C, int LDC, cmulti **A, int LDA, rmulti **B, int LDB)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      cadd_cr(MAT(C,i,j,LDC),MAT(A,i,j,LDA),MAT(B,i,j,LDB));
    }
  }
}
...
void cmat_add_c(int m, int n, cmulti **C, int LDC, cmulti **A, int LDA, cmulti *b)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      cadd_cc(MAT(C,i,j,LDC),MAT(A,i,j,LDA),b);
    }
  }
}
...
void cmat_sub(int m, int n, cmulti **C, int LDC, cmulti **A, int LDA, cmulti **B, int LDB)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      csub_cc(MAT(C,i,j,LDC),MAT(A,i,j,LDA),MAT(B,i,j,LDB));
    }
  }
}
...
void cmat_sub_rmat1(int m, int n, cmulti **C, int LDC, rmulti **A, int LDA, cmulti **B, int LDB)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      csub_rc(MAT(C,i,j,LDC),MAT(A,i,j,LDA),MAT(B,i,j,LDB));
    }
  }
}
...
void cmat_sub_rmat2(int m, int n, cmulti **C, int LDC, cmulti **A, int LDA, rmulti **B, int LDB)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      csub_cr(MAT(C,i,j,LDC),MAT(A,i,j,LDA),MAT(B,i,j,LDB));
    }
  }
}
...
void cmat_sub_c1(int m, int n, cmulti **C, int LDC, cmulti *a, cmulti **B, int LDB)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      csub_cc(MAT(C,i,j,LDC),a,MAT(B,i,j,LDB));
    }
  }
}
...
void cmat_sub_c2(int m, int n, cmulti **C, int LDC, cmulti **A, int LDA, cmulti *b)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      csub_cc(MAT(C,i,j,LDC),MAT(A,i,j,LDA),b);
    }
  }
}
...
void cmat_mul(int m, int n, cmulti **C, int LDC, cmulti **A, int LDA, cmulti **B, int LDB)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      cmul_cc(MAT(C,i,j,LDC),MAT(A,i,j,LDA),MAT(B,i,j,LDB));
    }
  }
}
...
void cmat_mul_c(int m, int n, cmulti **C, int LDC, cmulti **A, int LDA, cmulti *b)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      cmul_cc(MAT(C,i,j,LDC),MAT(A,i,j,LDA),b);
    }
  }
}
...
void cmat_mul_r(int m, int n, cmulti **C, int LDC, cmulti **A, int LDA, rmulti *b)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      cmul_cr(MAT(C,i,j,LDC),MAT(A,i,j,LDA),b);
    }
  }
}
...
void cmat_mul_z(int m, int n, cmulti **C, int LDC, cmulti **A, int LDA, dcomplex b)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      cmul_cz(MAT(C,i,j,LDC),MAT(A,i,j,LDA),b);
    }
  }
}
...
void cmat_mul_d(int m, int n, cmulti **C, int LDC, cmulti **A, int LDA, double b)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      cmul_cd(MAT(C,i,j,LDC),MAT(A,i,j,LDA),b);
    }
  }
}
...
void cmat_prod(int l, int m, int n, cmulti **C, int LDC, cmulti **A, int LDA, cmulti **B, int LDB)
{
  ...
  for(i=0; i<l; i++){
    for(j=0; j<n; j++){
      ...
      for(k=0; k<m; k++){
	cadd_mul_cc(MAT(Z,i,j,l),MAT(A,i,k,LDA),MAT(B,k,j,LDB)); // Z=A*B
      }
    }
  }
...
void cmat_prod_r1(int l, int m, int n, cmulti **C, int LDC, rmulti **A, int LDA, cmulti **B, int LDB)
{
  ...
  for(i=0; i<l; i++){
    for(j=0; j<n; j++){
      cset_zero(MAT(Z,i,j,l)); // Z=0
      for(k=0; k<m; k++){
	cadd_mul_cr(MAT(Z,i,j,l),MAT(B,k,j,LDB),MAT(A,i,k,LDA)); // Z=A*B
      }
    }
  }
  cmat_copy(l,n,C,LDC,Z,l); // C=Z
...
void cmat_prod_r2(int l, int m, int n, cmulti **C, int LDC, cmulti **A, int LDA, rmulti **B, int LDB)
{
  ...
  for(i=0; i<l; i++){
    for(j=0; j<n; j++){
      cset_zero(MAT(Z,i,j,l)); // Z=0
      for(k=0; k<m; k++){
	cadd_mul_cr(MAT(Z,i,j,l),MAT(A,i,k,LDA),MAT(B,k,j,LDB)); // Z=A*B
      }
    }
  }
  cmat_copy(l,n,C,LDC,Z,l); // C=Z
...
void cmat_add_prod(int l, int m, int n, cmulti **C, int LDC, cmulti **A, int LDA, cmulti **B, int LDB)
{
  ...
  for(i=0; i<l; i++){
    for(j=0; j<n; j++){
      cset_c(MAT(Z,i,j,l),MAT(C,i,j,LDC)); // Z=C
      for(k=0; k<m; k++){
	cadd_mul_cc(MAT(Z,i,j,l),MAT(A,i,k,LDA),MAT(B,k,j,LDB)); // Z+=A*B
      }
    }
...
void cmat_sub_prod(int l, int m, int n, cmulti **C, int LDC, cmulti **A, int LDA, cmulti **B, int LDB)
{
  ...
  for(i=0; i<l; i++){
    for(j=0; j<n; j++){
      cset_c(MAT(Z,i,j,l),MAT(C,i,j,LDC)); // Z=C
      for(k=0; k<m; k++){
	csub_mul_cc(MAT(Z,i,j,l),MAT(A,i,k,LDA),MAT(B,k,j,LDB)); // Z-=A*B
      }
    }
  }
  cmat_copy(l,n,C,LDC,Z,l); // C=Z
...
void cmat_rank1op(int m, int n, cmulti **B, int LDB, cmulti **A, int LDA, cmulti *a, cmulti **x, cmulti **y)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      cdot_cc(value,y[j],x[i]);                     // vlaue=conj(y[j])*x[i]
      cmul_cc(value,a,value);                       // value=a*conj(y[j])*x[i]
...
void cmat_diag_copy_cvec(int m, int n, cmulti **A, int LDA, cmulti **a)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      if(i==j){ cset_c(MAT(A,i,j,LDA),a[i]); }
...
void cmat_diag_copy_rvec(int m, int n, cmulti **A, int LDA, rmulti **a)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      if(i==j){ cset_r(MAT(A,i,j,LDA),a[i]); }
      else    { cset_zero(MAT(A,i,j,LDA)); }
    }
  }
}
...
void cmat_diag_add_cvec(int m, int n, cmulti **B, int LDB, cmulti **A, int LDA, cmulti **a)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      if(i==j){ cadd_cc(MAT(B,i,j,LDB),MAT(A,i,j,LDA),a[i]); }
      else    { cset_c(MAT(B,i,j,LDB),MAT(A,i,j,LDA)); }
    }
  }
}
...
void cmat_diag_add_c(int m, int n, cmulti **B, int LDB, cmulti **A, int LDA, cmulti *a)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      if(i==j){ cadd_cc(MAT(B,i,j,LDB),MAT(A,i,j,LDA),a); }
      else    { cset_c(MAT(B,i,j,LDB),MAT(A,i,j,LDA)); }
    }
  }
}
...
void cmat_diag_add_rvec(int m, int n, cmulti **B, int LDB, cmulti **A, int LDA, rmulti **a)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      if(i==j){ cadd_cr(MAT(B,i,j,LDB),MAT(A,i,j,LDA),a[i]); }
      else    { cset_c(MAT(B,i,j,LDB),MAT(A,i,j,LDA)); }
    }
  }
}
...
void cmat_diag_add_r(int m, int n, cmulti **B, int LDB, cmulti **A, int LDA, rmulti *a)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      if(i==j){ cadd_cr(MAT(B,i,j,LDB),MAT(A,i,j,LDA),a); }
      else    { cset_c(MAT(B,i,j,LDB),MAT(A,i,j,LDA)); }
    }
  }
}
...
void cmat_diag_sub_cvec(int m, int n, cmulti **B, int LDB, cmulti **A, int LDA, cmulti **a)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      if(i==j){ csub_cc(MAT(B,i,j,LDB),MAT(A,i,j,LDA),a[i]); }
      else    { cset_c(MAT(B,i,j,LDB),MAT(A,i,j,LDA)); }
    }
  }
}
...
void cmat_diag_sub_c(int m, int n, cmulti **B, int LDB, cmulti **A, int LDA, cmulti *a)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      if(i==j){ csub_cc(MAT(B,i,j,LDB),MAT(A,i,j,LDA),a); }
      else    { cset_c(MAT(B,i,j,LDB),MAT(A,i,j,LDA)); }
    }
  }
}
...
void cmat_diag_sub_rvec(int m, int n, cmulti **B, int LDB, cmulti **A, int LDA, rmulti **a)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      if(i==j){ csub_cr(MAT(B,i,j,LDB),MAT(A,i,j,LDA),a[i]); }
      else    { cset_c(MAT(B,i,j,LDB),MAT(A,i,j,LDA)); }
    }
  }
}
...
void cmat_diag_sub_r(int m, int n, cmulti **B, int LDB, cmulti **A, int LDA, rmulti *a)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      if(i==j){ csub_cr(MAT(B,i,j,LDB),MAT(A,i,j,LDA),a); }
      else    { cset_c(MAT(B,i,j,LDB),MAT(A,i,j,LDA)); }
    }
  }
}
...
void cmat_div(int m, int n, cmulti **C, int LDC, cmulti **A, int LDA, cmulti **B, int LDB)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      cdiv_cc(MAT(C,i,j,LDC),MAT(A,i,j,LDA),MAT(B,i,j,LDB));
    }
  }
}
...
void cmat_div_c1(int m, int n, cmulti **C, int LDC, cmulti *a, cmulti **B, int LDB)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      cdiv_cc(MAT(C,i,j,LDC),a,MAT(B,i,j,LDB));
    }
  }
}
...
void cmat_div_c2(int m, int n, cmulti **C, int LDC, cmulti **A, int LDA, cmulti *b)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      cdiv_cc(MAT(C,i,j,LDC),MAT(A,i,j,LDA),b);
    }
  }
}
...
void cmat_abs(int m, int n, rmulti **B, int LDB, cmulti **A, int LDA)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      rabs_c(MAT(B,i,j,LDB),MAT(A,i,j,LDA));
    }
  }
}
...
void cmat_arg(int m, int n, rmulti **B, int LDB, cmulti **A, int LDA)
{
  ...
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      rarg_c(MAT(B,i,j,LDB),MAT(A,i,j,LDA));
    }
  }
}
...
void cmat_max_absc(rmulti *value, int m, int n, cmulti **A, int LDA)
{
  ...
  rmulti *a=NULL;
  a=rallocate_prec(rget_prec(value));
  rabs_r(value,C_R(MAT(A,0,0,LDA)));
  rabs_r(a,C_I(MAT(A,0,0,LDA)));
  if(gt_rr(a,value)){ rset_r(value,a); }
  for(j=0; j<n; j++){
    for(i=0; i<m; i++){
      rabs_r(a,C_R(MAT(A,i,j,LDA)));
      if(gt_rr(a,value)){ rset_r(value,a); }
      rabs_r(a,C_I(MAT(A,i,j,LDA)));
      if(gt_rr(a,value)){ rset_r(value,a); }
    }
  }
  a=rfree(a);

...
void cvec_add_rvec(int n, cmulti **z, cmulti **x, rmulti **y);     // z=x+y
void cvec_add_r(int n, cmulti **z, cmulti **x, rmulti *y);         // z=x+y
void cvec_add_z(int n, cmulti **z, cmulti **x, dcomplex y);        // z=x+y
void cvec_add_d(int n, cmulti **z, cmulti **x, double y);          // z=x+y
